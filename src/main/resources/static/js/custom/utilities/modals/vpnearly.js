...
var KTModalBidding = function () {
    ...
    // Handle bid options
    const handleBidOptionsserver_amount = () => {
        const options = form.querySelectorAll('[data-kt-modal-bidding="option"]');
        const inputEl = form.querySelector('[name="server_amount"]');
    ...
    const handleBidOptionsusers_amount = () => {
        const options = form.querySelectorAll('[data-kt-modal-bidding="option"]');
        const inputEl = form.querySelector('[name="users_amount"]');
        options.forEach(option => {
            option.addEventListener('click', e => {
                e.preventDefault();
    ...
    return {
        init: function () {
            ...
            handleBidOptionsserver_amount();
            handleBidOptionsusers_amount();
